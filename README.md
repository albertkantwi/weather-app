...
- This website shows a sneak peek into the projects I have developed and deployed, showcasing my skills in HTML, CSS, JavaScript and APIs. With a passion for web development, I have honed my expertise in these technologies to create stunning and functional websites.
...
```sh
  ...
  git clone https://github.com/albertkantwi/weather-app.git
  cd weather-app
...
Feel free to check the [Isuues Pages](https://github.com/albertkantwi/weather-app/issues)
